...
module.exports = async(bot) => {
    ...
    const commands = [
        ...
        new SlashCommandBuilder()
        .setName("youtube")
        .setDescription("Regardez des vidéos ensemble !")
        .addStringOption(option => option.setName("salon").setDescription("Salon dans lequel YouTube se lancera.").setRequired(true))
    ]
